========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : SnakeGame
========================================================================


AppWizard が生成した SnakeGame には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには SnakeGame を構成している各ファイルの概要説明が含まれています。
...
SnakeGame.h
    ...
    みます） をインクルードし、また CSnakeGameApp アプリケーションクラスを宣
    言します。

SnakeGame.cpp
    このファイルは CSnakeGameApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\SnakeGame.ico
    ...
    ルです。このアイコンはリソース ファイル SnakeGame.rc によってインクルード
    されます。
...
SnakeGameDlg.h, SnakeGameDlg.cpp - ダイアログ
    これらのファイルは CSnakeGameDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な SnakeGame.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) SnakeGame.pch 
